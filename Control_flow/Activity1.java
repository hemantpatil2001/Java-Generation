/*Using IntelliJ, write a Java app that takes numerical input from a user
	...
	1001 - 4999$	10%
	below 1000$	N/A
	Example: if a user enters 7677 as their sales figure, it should calculate commission
	 at 20%.*/
...
public class Activity1 {
	...
	public static void main(String args[])
	{
		...
		if(sale_fig > 10000)
		{
			...
			System.out.print("Commission : "+sale_fig);
		}
		...
		else if(sale_fig >= 1001 && sale_fig <= 49999)
		{
